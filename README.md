...
Deep learning project for Knee Osteoarthritis grading from X-ray images using ResNet18. The model classifies knee X-rays into OA grades 0–4 based on disease severity
## Overview
